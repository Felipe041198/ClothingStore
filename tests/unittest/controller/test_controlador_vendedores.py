...
class TestControladorVendedores(TestCase):
    ...
    @patch('src.view.tela_vendedores.TelaVendedores.exibir_vendedores')
    ...
    @patch('src.view.tela_vendedores.TelaVendedores.exibir_vendedor')
    ...
    @patch('src.view.tela_vendedores.TelaVendedores.obter_cpf')
    @patch('src.view.tela_vendedores.TelaVendedores.sucesso_exclusao')
